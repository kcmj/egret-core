...
var ResSplitPlugin = /** @class */ (function () {
    ...
    ResSplitPlugin.prototype.onFile = function (file) {
    ...
    ResSplitPlugin.prototype.onFinish = function (pluginContext) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return ResSplitPlugin;
}());
exports.ResSplitPlugin = ResSplitPlugin;
